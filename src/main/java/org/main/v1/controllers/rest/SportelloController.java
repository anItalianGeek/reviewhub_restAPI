...
import org.main.v1.controllers.repositories.GiornoRepository;
import org.main.v1.controllers.repositories.IscrizioneSportelloRepository;
...
import org.main.v1.models.wrappers.Iscrizione;
import org.main.v1.models.wrappers.WrapperSportelliDocente;
...
@RestController
@RequestMapping("/api/v1/sportello")
public class SportelloController {
    ...
    @Async("requestHandler")
    @GetMapping("/all")
    public CompletableFuture<ResponseEntity<List<Sportello>>> getSportelli(@RequestParam int offset, @RequestParam(required = false) Integer limit) {
        return CompletableFuture.supplyAsync(() -> {
            Pageable pageable;

            if (limit == null) pageable = PageRequest.of(offset, 10);
            else pageable = PageRequest.of(offset, limit);

            List<Sportello> list = sportelloRepository.findAllByPage(pageable).getContent();
            list.forEach(e -> {
    ...
    public CompletableFuture<ResponseEntity<List<Sportello>>> getSportelliDisponibili(@RequestParam int offset, @RequestParam(required = false) Integer limit) {
        return CompletableFuture.supplyAsync(() -> {
            Pageable pageable;
            if (limit == null) pageable = PageRequest.of(offset, 10);
            else pageable = PageRequest.of(offset, limit);

            List<Sportello> list = sportelloRepository.getSportelliDisponibili(pageable).getContent();
            list.forEach(e -> {
                e.getAula().setSportelli(null);
                e.getMateria().setSportelli(null);
                e.getDocente_responsabile().setPassword(null);
    ...
    public CompletableFuture<ResponseEntity<List<Sportello>>> getSportelliPrenotati(@RequestParam String author, @RequestParam Integer offset, @RequestParam(required = false) Integer limit) {
        return CompletableFuture.supplyAsync(() -> {
            Pageable pageable;
            ...
            List<Sportello> list = sportelloRepository.getSportelliPrenotati(author + DOMAIN, pageable).getContent();
            list.forEach(e -> {
                e.getAula().setSportelli(null);
                e.getMateria().setSportelli(null);
                e.getDocente_responsabile().setPassword(null);
    ...
    public CompletableFuture<ResponseEntity<WrapperSportelliDocente>> getSportelliByDocente(@PathVariable String author, @RequestParam int offset, @RequestParam(required = false) Integer limit) {
        return CompletableFuture.supplyAsync(() -> {
            Pageable pageable;
            ...
            List<Sportello> sportelli = sportelloRepository.getSportelliByDocente(author + DOMAIN, pageable).getContent();
            LinkedList<Iscrizione> iscrizioni = new LinkedList<>();
